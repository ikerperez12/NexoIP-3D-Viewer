...
export default function ModelInspector({
  ...
  return (
    <aside className="absolute top-20 right-4 bottom-4 w-80 md:w-96 z-20 glass-panel rounded-2xl flex flex-col overflow-hidden shadow-2xl animate-fade-in pointer-events-auto">
      {/* Header */}
