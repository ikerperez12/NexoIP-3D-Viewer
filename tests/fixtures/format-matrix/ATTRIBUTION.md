...
| `ply-mesh/colored-triangle.ply` | Authored NexoIP ASCII PLY mesh with vertex colours and normals. | NexoIP test data under the repository MIT license. |
| `invalid/malformed.{gltf,obj,stl,ply,fbx,dae}` and `invalid/missing-material.obj` | Authored NexoIP negative fixtures covering truncated, geometry-free and missing-resource inputs. | NexoIP test data under the repository MIT license. |
| generated `animated-triangle.glb` | Deterministically generated by `scripts/packaged-fixture-matrix.mjs`; SHA-256 `780e30952df2a6db16face5375e851aeb24801ba4746c93c179ca970fe38bc29`. | NexoIP test data under the repository MIT license. It is created only in an OS temporary directory for artifact tests and is never shipped in the application. |
